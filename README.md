...
🛍️ Retail Performance & KPI Analysis | Excel + SQL + Power BI

This project demonstrates a complete data analytics pipeline — starting from data collection in Excel, moving through data transformation and analysis using SQL, and ending with insightful visualization in Power BI.

It highlights how data can be transformed into meaningful insights that help businesses understand performance trends, customer behavior, and profitability drivers.

🎯 Project Objective

To design and develop a Retail Business Intelligence Dashboard that:

-  Tracks key metrics like Sales, Profit, Margin, and Discount.

-  Identifies top-performing products, states, and account managers.

-  Analyzes customer type contributions and shipping mode efficiency.

-  Provides a clear, interactive, and decision-focused dashboard for business users.
